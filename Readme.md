...
Учебный демо-проект от HTML Academy для 8-го потока профессионального онлайн‑курса «React. Разработка сложных клиентских приложений».

### Как пользоваться репозиторием

Первый вариант, это изучать коммиты [в веб-интерфейсе GitHub в master-ветке потока](https://github.com/htmlacademy-react/guess-melody-8/tree/master).
...
8. `git cherry-pick -n --strategy-option theirs`
